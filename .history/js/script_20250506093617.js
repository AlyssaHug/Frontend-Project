    ...
    if (name === "My Computer") {
        content.innerHTML = `
            ...
            gameState.stage >= 2 ? "DISABLED" : "Active"
                    ...
                    <div class="log-entry ${
                        gameState.stage >= 1 ? "warning" : ""
                    }">Privacy Protection: ${gameState.stage >= 1 ? "WARNING" : "Active"}</div>
                </div>
            </div>
            <div class="settings-section">
...
function initFox() {
    // === START OF CHANGES ===
    // Set initial Foxy image
    foxElement.innerHTML = `<img src="img/foxyclose.svg" alt="Foxy">`;
    // === END OF CHANGES ===
...
function showFoxMessage(message) {
    ...
    foxElement.querySelector('img').src = 'img/foxyopen.svg';
    // === END OF CHANGES ===
    ...
    setTimeout(() => {
        ...
        foxElement.querySelector('img').src = 'img/foxyclose.svg';
    }, 5000);
    // === END OF CHANGES ===
}
